...
///////////////////////////////////////////////////////////////////////////////////
   ...
   bool aArteASCII(const char grises[], char arteASCII[], int maxlong, int nGrises) const;

   Imagen combinarCon(const Imagen &img, int k, int npasos) const;
///////////////////////////////////////////////////////////////////////////////////

  void operator = (const Imagen &imag);
